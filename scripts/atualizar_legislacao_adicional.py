...
NORMAS=[
 {'norma_id':'rdc-anvisa-22-2014','norma':'RDC 22-2014','grupo':'rdc-anvisa','rotulo':'RDC Anvisa nº 22/2014','url':'https://anvisalegis.datalegis.net/action/ActionDatalegis.php?acao=abrirTextoAto&cod_menu=8542&cod_modulo=310&link=S&numeroAto=00000022&orgao=RDC%2FDC%2FANVISA%2FMS&seqAto=000&tipo=RDC&valorAno=2014','data_fonte':'2014-04-29','status_vigencia':'vigente','min_chars':9000,'obrig':['RDC Nº 22','SNGPC','Art. 1']},
 {'norma_id':'decreto-estadual-sp-69118-2024','norma':'Decreto Estadual SP 69118-2024','grupo':'decreto-estadual-sp','rotulo':'Decreto Estadual SP nº 69.118/2024','url':'https://www.al.sp.gov.br/repositorio/legislacao/decreto/2024/decreto-69118-09.12.2024.html','data_fonte':'2024-12-09','status_vigencia':'sem_revogacao_expressa','min_chars':12000,'obrig':['DECRETO N° 69.118','Segurança Contra Incêndios','Artigo 1']},
 {'norma_id':'lei-municipal-sp-13478-2002','norma':'Lei Municipal SP 13478-2002','grupo':'lei-municipal','rotulo':'Lei Municipal SP nº 13.478/2002 — texto consolidado','url':'https://legislacao.prefeitura.sp.gov.br/lei-13478-de-30-de-dezembro-de-2002','data_fonte':'2002-12-30','status_vigencia':'alterada_parcialmente_inconstitucional_parcialmente_revogada','min_chars':30000,'obrig':['LEI Nº 13.478','Sistema de Limpeza Urbana','Art. 1']},
 {'norma_id':'lei-federal-10357-2001','norma':'Lei 10357-2001','grupo':'lei-federal','rotulo':'Lei Federal nº 10.357/2001 — texto consolidado','url':'https://www.planalto.gov.br/ccivil_03/leis/leis_2001/l10357.htm','data_fonte':'2001-12-27','status_vigencia':'vigente_com_alteracoes','min_chars':10000,'obrig':['LEI Nº 10.357','produtos químicos','Art. 1']},
 {'norma_id':'lei-estadual-sp-15266-2013','norma':'Lei Estadual SP 15266-2013','grupo':'lei-estadual-sp','rotulo':'Lei Estadual SP nº 15.266/2013 — texto atualizado','url':'https://www.al.sp.gov.br/repositorio/legislacao/lei/2013/lei-15266-26.12.2013.html','data_fonte':'2013-12-26','status_vigencia':'sem_revogacao_expressa_com_alteracoes','min_chars':25000,'obrig':['LEI N° 15.266','Taxa de Fiscalização','Artigo 1']},
]
...
def extrair_html(body):
    ...
    for ln in txt.splitlines():
        ...
        # ALESP usa "Artigo"; o estruturador v12 usa Art.
...
def main():
    ...
    for n in NORMAS:
        ...
        rel['normas'].append({'norma':n['norma'],'arquivo':fn,'nos':len(doc['nos']),'chars':len(txt),'status_vigencia':n['status_vigencia'],'fonte':n['url']})
