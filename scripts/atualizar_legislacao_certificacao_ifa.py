...
NORMAS = [
    {
        ...
        "nota_fonte_texto": "Espelho institucional do Centro de Vigilância Sanitária do Estado de São Paulo utilizado para extração técnica do texto publicado no DOU. A referência normativa oficial permanece o Diário Oficial da União. A Anvisa informa que a RDC 362/2020 foi substituída pela RDC 672/2022.",
        ...
        "min_chars": 5000,
        "obrig": ["RDC Nº 362", "insumos farmacêuticos ativos", "Art. 1"],
    },
    {
