...
NORMAS = [
    {
        ...
        "url": "https://www.conass.org.br/conass-informa-n-145-2020-publicada-a-rdc-anvisa-n-362-que-dispoe-sobre-os-criterios-para-certificacao-de-boas-praticas-de-fabricacao-e-institui-o-programa-de-inspecao-para-estabelecimento/",
        "fonte_normativa_oficial": "https://pesquisa.in.gov.br/imprensa/servlet/INPDFViewer?captchafield=firstAccess&data=01%2F04%2F2020&jornal=515&pagina=100",
        "fonte_status": "https://www.gov.br/anvisa/pt-br/assuntos/noticias-anvisa/2022/revisaco-entenda-como-ficaram-as-normas-da-area-de-fiscalizacao/",
        "nota_fonte_texto": "Espelho institucional do CONASS utilizado para extração técnica do texto integral da RDC 362/2020. A referência normativa oficial permanece o Diário Oficial da União. A Anvisa informa que a RDC 362/2020 foi substituída pela RDC 672/2022.",
        "data_fonte": "2020-03-27",
        "status_vigencia": "revogada_pela_rdc_672_2022",
        "status_fonte": "Anvisa: RDC 362/2020 foi substituída pela RDC 672/2022; a RDC 672/2022 revoga expressamente a RDC 362/2020",
        "min_chars": 5000,
        "obrig": ["RDC ANVISA Nº 362", "insumos farmacêuticos ativos", "Art. 1"],
    },
    {
        "norma_id": "rdc-anvisa-497-2021",
        "norma": "RDC 497-2021",
        "grupo": "rdc-anvisa",
        "rotulo": "RDC Anvisa nº 497/2021 — texto consolidado",
        ...
        "fonte_normativa_oficial": "https://anvisalegis.datalegis.net/action/ActionDatalegis.php?acao=abrirTextoAto&cod_menu=8542&cod_modulo=310&link=S&numeroAto=00000497&orgao=RDC%2FDC%2FANVISA%2FMS&seqAto=000&tipo=RDC&valorAno=2021",
        "fonte_status": "https://anvisalegis.datalegis.net/action/ActionDatalegis.php?acao=abrirTextoAto&cod_menu=8542&cod_modulo=310&link=S&numeroAto=00000497&orgao=RDC%2FDC%2FANVISA%2FMS&seqAto=000&tipo=RDC&valorAno=2021",
        "nota_fonte_texto": "Texto consolidado do AnvisaLegis. O texto consultado contém alterações posteriores, incluindo RDC 850/2024, RDC 982/2025 e RDC 1.032/2026.",
...
def main() -> int:
    ...
    relatorio = {
        "schema": "relatorio-legislacao-certificacao-ifa-v1",
        "gerado_em": agora(),
    ...
    (SAIDA / "relatorio-legislacao-certificacao-ifa.json").write_text(
